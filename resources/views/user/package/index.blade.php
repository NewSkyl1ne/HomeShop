                                ...
                                <div class="col-lg-6">
                                    ...
                                    @if(!empty($package))
                                        @if($package->subscription_id == $sub->id)
                                            ...
                                            @endif
                                             <a href="{{route('user-vendor-request',$sub->id)}}" class="hover-white  adbs "><u>Renew</u></a>
                                        @else
                                            <a href="{{route('user-vendor-request',$sub->id)}}" class=" adbs">Get Started</a>
                                            <br><small>&nbsp;</small>
                                        @endif
                                    @else
                                        <a href="{{route('user-vendor-request',$sub->id)}}" class=" adbs">Get Started</a>
...
{{--                                         <a href="#" class=" adbs">Get Started Now</a>   --}}                
                                    </div>
                                </div>
