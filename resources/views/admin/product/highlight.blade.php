										...
										<div class="product-description">
											...
											<form id="geniusformdata" action="{{route('admin-prod-feature',$data->id)}}" method="POST" enctype="multipart/form-data">
												...
												<div class="row">
													<div class="col-lg-8">
														<div class="left-area">
																<h4 class="heading">Highlight in Latest *</h4>
														</div>
													</div>
									                  <div class="col-sm-3">
									                    <label class="switch">
												...
												*/ ?>
												...
												<div class="row">
													<div class="col-lg-8">
														<div class="left-area">
																<h4 class="heading">Highlight in {{ $langg->lang31 }} (Latest ) *</h4>
														</div>
													</div>
									                  <div class="col-sm-3">
									                    <label class="switch">
												...
												*/
												...
												<div class="row">
													<div class="col-lg-8">
														<div class="left-area">
																<h4 class="heading">Highlight in Discount *</h4>
														</div>
													</div>
									                  <div class="col-sm-3">
									                    <label class="switch">
												...
												<div class="row">
													<div class="col-lg-6">
									                  ...
									                  <div class="col-sm-6">
									                      <input type="text" class="input-field" name="discount"  placeholder="Enter Discount" id="discount" value="{{ $data->discount }}">
