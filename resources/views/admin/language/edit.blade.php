                     ...
                     <hr>
                      ...
                      <hr>
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="lang235" placeholder="Vendor Register" required="" value="{{ $lang->lang235 }}">
                          </div>
                        </div>
                      ...
                      <hr>
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="lang233" placeholder="Become a Vendor" required="" value="{{ $lang->lang233 }}">
                          </div>
                        </div>
