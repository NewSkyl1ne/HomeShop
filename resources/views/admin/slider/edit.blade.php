                                              ...
                                              <div class="form-group">
                                                  <div class="col-sm-12">
                                                    <label class="control-label" for="subtitle_text">Title*</label>
                                                     <input class="form-control" type="text" name="subtitle_text" id="subtitle_text"  placeholder="Enter Title Text" value="{{$data->subtitle_text}}" >
                                                </div>
                                              </div>
 ...
 -->
                                      ...
                                      <!-- <div class="panel panel-default slider-panel">
                                              ...
                                              <div class="form-group">
                                                  ...
                                                  <textarea class="form-control" name="details_text" id="details_text" rows="5"  placeholder="Enter Description Text">{{$data->details_text}}</textarea>
                                                </div>
                                              </div>
