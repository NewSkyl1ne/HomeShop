...
Route::prefix('admin')->group(function() {
  ...
  Route::get('/products/review/{id}', 'Admin\ProductController@review')->name('admin-prod-review');
  Route::get('/products/noreview/{id}', 'Admin\ProductController@noreview')->name('admin-prod-noreview');
...
Route::get('/subscription/delete/{id}', 'Admin\SubscriptionController@destroy')->name('admin-subscription-delete');
  ...
  Route::get('/banner/datatables', 'Admin\BannerController@datatables')->name('admin-sb-datatables'); //JSON REQUEST
...
// ************************************ USER SECTION **********************************************
 Route::get('/map', 'Front\FrontendController@mapView')->name('map');

Route::get('/getInvoice', 'Front\FrontendController@getInvoice');
Route::prefix('user')->group(function() {
  Route::get('/website', 'Front\FrontendController@index')->name('website');
  // User Dashboard
  Route::get('/dashboard', 'User\UserController@index')->name('user-dashboard');
  // Shipping Address
  Route::get('/shippingAddress', 'User\ShippingAddressController@index')->name('user-shipping-address');  
  Route::get('/addShippingAddress', 'User\ShippingAddressController@add')->name('user-add-shipping-address');  
  Route::post('/saveShippingAddress', 'User\ShippingAddressController@save')->name('user-save-shipping-address');  
  Route::get('/editShippingAddress/{id}', 'User\ShippingAddressController@edit')->name('user-edit-shipping-address');
  Route::post('/updateShippingAddress/{id}', 'User\ShippingAddressController@update')->name('user-update-shipping-address');  
  Route::get('/deleteShippingAddress/{id}', 'User\ShippingAddressController@delete')->name('user-delete-shipping-address');
  // User Login
  ...
  // User Review
  // Route::post('/review/submit','User\UserController@reviewsubmit')->name('review.submit');
  Route::post('/review/submit','Api\RatingController@reviewsubmit')->name('review.submit');
  Route::post('/review/update/submit','Api\RatingController@reviewupdatesubmit')->name('review.update.submit');
  Route::post('/review/delete','Api\RatingController@reviewdelte')->name('review-delete-submit');
  // User Review Ends
...
// User Orders
  ...
  Route::get('/order/cancle/{id}', 'User\OrderController@cancleOrder')->name('order-cancle-request');
...
Route::prefix('vendor')->group(function() {
  ...
  // CREATE SECTION
  // SHOPES 
  Route::get('/shops', 'Vendor\ShopsController@index')->name('vendor-shops');
  Route::get('/shops/create', 'Vendor\ShopsController@create')->name('vendor-shops-create');
  Route::post('/shops/createNew', 'Vendor\ShopsController@createNew')->name('vendor-shops-createNew');
  Route::post('/shops/edit', 'Vendor\ShopsController@edit')->name('vendor-shops-edit');
  Route::get('/shops/delete', 'Vendor\ShopsController@delete')->name('vendor-shops-delete');
  //Route::get('/vendor/vendor-shops', 'Vendor\ShopsController@types')->name('vendor-shops');
  // EDIT SECTION
  ...
  Route::get('/products/review/{id}', 'Vendor\ProductController@review')->name('vendor-prod-review');
  Route::get('/products/noreview/{id}', 'Vendor\ProductController@noreview')->name('vendor-prod-noreview');
  ...
  //Route::post('/shops', 'Vendor\ShopsController@index')->name('vendor-shop');
...
// ************************************ Cron Job**********************************************
  Route::get('/expirePackageProduct', 'Front\CronjobController@expirePackageProduct')->name('expirePackageProduct');
...
// ************************************ End Cron Job**********************************************
  ...
  Route::get('/store/vendors','Front\FrontendController@vendors')->name('front.vendors');
  Route::get('/store/vendors/shops/{name}/{id}','Front\FrontendController@vendorsshops')->name('front.shops');
  Route::get('/items/{id}','Front\FrontendController@items')->name('front.items');
  Route::get('/noitems/{id}','Front\FrontendController@noitems')->name('front.noitems');
  ...
  Route::post('/updateCart','Front\CartController@updateCart')->name('product.cart.update');
  // Route::get('/updateCart_ajax','Front\CartController@updateCart_ajax')->name('product.cart.updateCart_ajax');
  Route::post('/updateCart_ajax','Front\CartController@updateCart_ajax')->name('product.cart.updateCart_ajax');
  ...
  Route::post('/placeorder','Front\CheckoutController@placeorder')->name('front.placeorder');
  Route::get('/qpaySession/','Front\CheckoutController@qpaySession')->name('front.qpaySession');
  Route::get('/qpay_action_payemnt/','Front\CheckoutController@qpay_action_payemnt')->name('front.qpay_action_payemnt');
  Route::get('/qpay_action_return/','Front\CheckoutController@qpay_action_return')->name('front.qpay_action_return');

  Route::get('/user_qpaySession/','User\UserController@qpaySession')->name('user.qpaySession');
  Route::get('/user_qpay_action_payemnt/','User\UserController@qpay_action_payemnt')->name('user.qpay_action_payemnt');
  Route::get('/user_qpay_action_return/','User\UserController@qpay_action_return')->name('user.qpay_action_return');
  ...
  Route::get('/carts/outofstock', 'Front\CartController@outofstock')->name('front.cartoutstock');
  ...
  // PAGE SECTION
Route::get('/upload','Front\FrontendController@upload');
Route::post('/upload','Front\FrontendController@pUpload');



  Route::get('/{slug}','Front\FrontendController@page')->name('front.page');
  
  Route::post('/subscribers', 'Front\FrontendController@subscribers')->name('front-subscribers');
  Route::post('/sentEnquiry', 'Front\FrontendController@sentEnquiry')->name('front-sentEnquiry');
  // PAGE SECTION ENDS
