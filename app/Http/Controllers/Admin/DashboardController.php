...
class DashboardController extends Controller
{
    ...
    public function index()
    {
        ...
        $blogs = Blog::all();
        $pproducts = Product::orderBy('views','desc')->take(5)->get();
        ...
        return view('admin.dashboard',compact('pending','activation_notify','processing','completed','products','users','blogs','days','sales','pproducts','rorders'));
    }
