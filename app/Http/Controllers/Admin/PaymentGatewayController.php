...
class PaymentGatewayController extends Controller
{
   public function __construct()
    ...
    {
        //--- Validation Section
        $rules = ['title' => 'unique:payment_gateways', 'photo' => 'required|mimes:jpeg,jpg,png,svg,webp'];
    ...
    {
        //--- Validation Section
        $rules = ['title' => 'unique:payment_gateways,title,'.$id , 'photo' => 'mimes:jpeg,jpg,png,svg,webp'];
