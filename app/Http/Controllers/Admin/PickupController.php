...
class PickupController extends Controller
{
    ...
    public function datatables()
    {
         ...
         return Datatables::of($datas)
                            ->editColumn('action', function(Pickup $data) {
                            ...
                            ->editColumn('location', function(Pickup $data) {
                                
                                return $data->location;
                            })
                            ->editColumn('shipping_charge', function(Pickup $data) {
                                
                                return $data->shipping_charge;
                            })
                            ->rawColumns(['location','shipping_charge', 'action'])
