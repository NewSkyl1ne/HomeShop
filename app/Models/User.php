...
class User extends Authenticatable
{
    ...
    protected $fillable = ['name', 'photo', 'zip', 'residency', 'city','building_no','zone_no','street_no', 'address', 'phone', 'fax', 'email','password','affilate_code','verification_link','shop_name','owner_name','shop_number','shop_address','shop_type','reg_number','shop_message','is_vendor','shop_details','shop_image','f_url','g_url','t_url','l_url','f_check','g_check','t_check','l_check','shipping_cost','cr_doc','doc'];
